...
document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch to be drawn : " + quick_draw_data_set[random_number];
...
function updateCanvas() {
    ...
    document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch to drawn : " + sketch;
}
